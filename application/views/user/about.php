                ...
                <div class="testi-carousel owl-carousel owl-theme">
                    <div class="testimonial clearfix">
                        <div class="testi-meta">
                            <img src="<?php echo base_url('public/user/assets/') ?>images/testi_01.png" alt="" class="img-fluid">
                    ...
                    <div class="testimonial clearfix">
                        <div class="testi-meta">
                            <img src="<?php echo base_url('public/user/assets/') ?>images/testi_02.png" alt="" class="img-fluid">
                    ...
                    <div class="testimonial clearfix">
                        <div class="testi-meta">
                            <img src="<?php echo base_url('public/user/assets/') ?>images/testi_03.png" alt="" class="img-fluid ">
                            <h4>Venanda Mercy </h4>
                        </div>
                        <div class="desc">
